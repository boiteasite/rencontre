...
function rencontre_install_help() {
	...
	<ol>
		...
		<li><?php _e('You need the WordPress Login / Logout / Register links. Take a look in <a href="nav-menus.php">Appearance / Menus</a> if your theme has not these links.', 'rencontre'); ?>
			<br /><?php _e('If the menu tab is missing in appearance (theme full-site editing), install a classic theme (twenty-twenty-one) to create your menu. Then return to your theme and select the menu you\'ve just created', 'rencontre'); ?>
		</li>
		<li><?php _e('Add a new subscriber member in WP. Login this member and go to the plugin page (1).', 'rencontre'); ?>
			<br /><?php _e('To facilitate the settings after installing, you can download and install via CSV (<a href="admin.php?page=rencontre.php">Rencontre / General</a>) 20 test profiles with photo', 'rencontre'); _e(': ','rencontre'); ?><a href="https://www.boiteasite.fr/telechargement/rencontre_import_20_profiles.zip">zip</a>
		</li>
	</ol>
