			...
			<div class="w3-container w3-renc-lblc">
				<div class="w3-section">
					...
					<?php } ?>
						...
						<input type="hidden" name="sex" value="<?php echo $u0->i_sex; ?>" />
					...
					<?php if(!isset($rencCustom['size'])) { ?>
						...
						<div>
							...
							<div class="w3-row">
								<div class="w3-half">
									<select name="tailleMin" class="w3-select w3-border w3-renc-sebg" onChange="<?php echo $onClick['sizemin']; ?>">
								...
								<div class="w3-half">
									<select name="tailleMax" class="w3-select w3-border w3-renc-sebg" onChange="<?php echo $onClick['sizemax']; ?>">
										<?php for($v=140;$v<221;++$v) {
											if(empty($rencCustom['sizeu']))
					...
					<?php if(!isset($rencCustom['weight'])) { ?>
						...
						<div>
							...
							<div class="w3-row">
								<div class="w3-half">
									<select name="poidsMin" class="w3-select w3-border w3-renc-sebg" onChange="<?php echo $onClick['weightmin']; ?>">
								...
								<div class="w3-half">
									<select name="poidsMax" class="w3-select w3-border w3-renc-sebg" onChange="<?php echo $onClick['weightmax']; ?>">
										<?php for($v=40;$v<141;++$v) {
											if(empty($rencCustom['weightu']))
					...
					<?php if(isset($rencCustom['sex'])) { ?>
						...
						<div>
							...
							<select name="z2sex" class="w3-select w3-border w3-renc-sebg">
								<option value="">-</option>
					...
					<?php if(!isset($rencCustom['place'])) { ?>
						...
						<div id="rencCityTr">
							...
							<input id="rencVille" name="ville" type="text" class="w3-input w3-renc-inbg" value="<?php if(!empty($mem['city'])) echo $mem['city']; ?>" <?php if(!empty($map)) echo $onClick['city']; ?>/>
						</div>
					<?php } ?>
					...
					<?php echo $moreSearch1; ?>
						...
						<div>
							...
							<input type="text" name="mot" class="w3-input w3-renc-inbg" />
						</div>
						<div>
							<label><?php _e('Alias','rencontre');?></label>
							<input type="text" name="pseudo" class="w3-input w3-renc-inbg" />
						</div>
						<div class="w3-padding-small">
							<input type="checkbox" name="photo" style="margin:0 8px" value="1" <?php if(!empty($mem['photo'])) echo 'checked'; ?> />
